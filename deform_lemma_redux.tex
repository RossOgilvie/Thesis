...
=
\begin{bmatrix}
% \bra{Q\tilde{P}(\tilde{b}^1)^{-1}} (β_1) \\
% \bra{Q\tilde{P}(\tilde{b}^1)^{-1}}^{\prime} (β_1) \\
% \vdots \\
% \bra{Q\tilde{P}(\tilde{b}^1)^{-1}}^{(r_1-1)} (β_1) \\
% \bra{Q\tilde{P}(\tilde{b}^1)^{-1}} (β_2) \\
% \vdots \\
% \bra{Q\tilde{P}(\tilde{b}^1)^{-1}}^{(r_2-1)} (β_2) \\
% \bra{Q\tilde{P}(\tilde{b}^1)^{-1}} (β_3) \\
% \vdots \\
% \vdots \\
% \bra{Q\tilde{P}(\tilde{b}^1)^{-1}}^{(r_k-1)} (β_k) \\
