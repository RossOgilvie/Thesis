...
Cut open this space.
\item
Deal with blowup. the limit at this point, the new coordinates
\item
Extend past boundary, on both sides. Evoke SMT lemmata recipe
\item
prove properness, and in doing so find the strata at infinity (ie show it's bounded sway from the other edges)
\item
