...
Throughout this thesis we have made the assumption that the spectral curves are non-singular. In Chapter \ref{chp:Deformation} we saw that the moduli space of spectral data $\mathcal{M}_g$, and in particular $\mathcal{M}_1$ where the spectral curve is genus one, was two dimensional. Therefore non-isospectral deformation of the spectral data are possible. In the previous chapter, we proved that $\mathcal{M}_1$ was composed of ribbons $(0,1)\times \R$ and annuli. In this chapter we examine the limiting behaviour of the spectral data along the edges of $\mathcal{M}_1$, which we shall see correspond to the degeneration of the spectral curve to a singular curve.
