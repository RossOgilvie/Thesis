...
\makefigure{Plot of $K$ (black) and its upper and lower bounding approximates. The blue lower bound is
\[
...
\]}{thesis_graphics/K_inequality.png}
...
\makefigure{Plot of $E$ (black) and its upper and lower bounding approximates. The blue lower bound is
\[
...
\[
k^2 + (1-k^2)K(k).
\]}{thesis_graphics/E_inequality.png}
