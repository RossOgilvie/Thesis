...
\begin{document}
\makeheading{The genus one moduli surface}
\section{Definition}
...
Refer to the deformation lemma section to see the many variations that all show for at every point in $\mathcal{X}$ there is a $2$-space of tangent vectors. Therefore it is a two dimensional space \todo{manifold? How to show smoothness?}.
