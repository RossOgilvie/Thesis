...
\end{align*}
which shows that their sum is holomorphic at $z=\infty$. Unfortunately, this differential is not real with respect to $\tilde{ρ}$. To correct this deficency we shall add another exact differential. The space of exact differentials (not necessarily real) with the double poles over $ζ=0,\infty$ is
\[
