...
\[
ε := e + d\left[ \frac{w}{z + \bar{z}_0} \right] + \Re z_0\; d\left[ \frac{w}{(z-z_0)(z + \bar{z}_0)} \right]
...
\]
where $[\tilde{x}]_{\tilde{λ}}$ refers to the equivalence relation \eqref{eqn:annuli action}, such that the subspace of spectral curves $\mathcal{S}_1(1)$ is
\[
