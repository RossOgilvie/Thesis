...
The moduli space $\mathcal{S}$ is a subspace of this parameter space $P$ defined implicitly by the two conditions that $p$ and $T$ are constant. Having established formula for the inverse transformation from the new coordinates, it is time to rewrite $T_0$ in terms of $(p,k,u,v)$. Particularly, we must compute the factors in the third term of $T_0$. By direct computation
\begin{align*}
