...
\]
so we take as our third basis differential
\[
λ := e + d\left[ \frac{w}{z + \bar{z}_0} \right] + z_0d\left[ \frac{w}{(z-z_0)(z + \bar{z}_0)} \right]
= e + d\left[ \frac{wz}{(z-z_0)(z + \bar{z}_0)} \right],
\]
...
\[
Θ^2 = 2E ω - 2Ke - 2K d\left[ \frac{wz}{(z-z_0)(z + \bar{z}_0)} \right]
\]
