...
The key to describing the topology of $\mathcal{S}_1$ lies in the construction of coordinate charts for subspaces of $\mathcal{\tilde{C}}_1$ with the dual properties that the group of covering transformations acts as translations and also that the preimage $\mathcal{\tilde{S}}_1$ of $\mathcal{S}_1$ in $\mathcal{\tilde{C}}_1$ is the subset where certain coordinates take rational values. To accomplish the first goal, we will construct a global coordinate chart on $\mathcal{\tilde{C}}_1$,
\[
\mathcal{\tilde{C}}_1 =
