...
To apply this to a harmonic map $f:M\to G$, pull back the Maurer-Cartan form of $G$ to $φ = 2(Φ - Φ^*)$, where $2Φ$ is the $(1,0)$ part of the form $φ$. Harmonicity of $f$ implies that
\[
d_A'' Φ = 0.
\]
