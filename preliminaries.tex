...
We shall illustrate two properties of these spaces $\mathcal{P}^k_\R$. Firstly a multiplicative property, and secondly that they are disjoint from one another. Suppose that $p \in \mathcal{P}^k_\R$ and $q \in \mathcal{P}^l_\R$. Then it follows immediately that $pq \in \mathcal{P}^{k+l}_\R$,
\[
ρ^*(pq)
= \bar{ζ}^{-k-l} \bar{(pq)(ζ)}
