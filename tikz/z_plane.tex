...
\draw[->,color=red] (-3.3,0)--(3.3,0) node[below left,color=black]{$\Real z$};
...
\fill (0,0) circle (0.05) node[above right, color=blue]{$\mu$} node[below left,color=black]{$0$};
\fill (1,0) circle (0.05) node[above, color=blue]{$\alpha$} node[below,color=black]{$1$};
\fill (2.1,0) circle (0.05) node[above, color=blue]{$\beta$} node[below,color=black]{$k^{-1}$};
\fill (-1,0) circle (0.05) node[above, color=blue]{$\bar{\alpha}^{-1}$} node[below,color=black]{$-1$};
